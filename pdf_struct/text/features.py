...
def extract_features(texts: List[TextLine]):
    ...
    for t1, t2, t3, t4 in groupwise(texts, 4):
        ...
        feat = (
            ...
            features.colon_ish(_gt(t1), _gt(t1)),
            features.punctuated(_gt(t1), _gt(t1)),
            features.punctuated(_gt(t1), _gt(t1)),
            line_break(t1, t2),
            line_break(t2, t3),
            features.list_ish(_gt(t1), _gt(t1)),
            indent(t1, t2),
            indent(t2, t3),
            indent_body(t1, t2),
            indent_body(t2, t3),
            features.therefore(_gt(t1), _gt(t1)),
            features.therefore(_gt(t1), _gt(t1)),
            features.all_capital(_gt(t1)),
            features.all_capital(_gt(t1)),
            features.mask_continuation(_gt(t1), _gt(t1)),
            features.mask_continuation(_gt(t1), _gt(t1)),
            features.space_separated(_gt(t1)),
            features.space_separated(_gt(t1)),
            centered(t2),
            centered(t3),
            extra_line_space(t2),
